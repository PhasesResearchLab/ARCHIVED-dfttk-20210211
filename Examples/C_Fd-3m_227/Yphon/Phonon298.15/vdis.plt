...
set xtics ( '{/Symbol G}' qunit*0.000000, 'X' qunit*0.279816, '{/Symbol G}' qunit*0.675536, 'L' qunit*0.917864, 'X' qunit*1.160192)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*0.000000:funit*43.000000] \
