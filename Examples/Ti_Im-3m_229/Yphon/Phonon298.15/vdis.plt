...
set xtics ( '{/Symbol G}' qunit*0.000000, 'X' qunit*0.376448, '{/Symbol G}' qunit*0.593790, 'L' qunit*0.811133, 'X' qunit*1.028475)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*-6.000000:funit*7.000000] \
