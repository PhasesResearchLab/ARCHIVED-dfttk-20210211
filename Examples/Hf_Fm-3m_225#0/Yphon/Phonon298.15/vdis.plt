...
set xtics ( '{/Symbol G}' qunit*0.000000, 'X' qunit*0.223141, '{/Symbol G}' qunit*0.538710, 'L' qunit*0.731956, 'X' qunit*0.925202)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*0.000000:funit*4.000000] \
