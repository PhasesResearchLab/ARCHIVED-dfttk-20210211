...
set xtics ( '{/Symbol G}' qunit*0.000000, 'K' qunit*0.363495, '{/Symbol G}' qunit*0.573358, 'A' qunit*0.688265, 'L' qunit*1.051760, 'M' qunit*1.166666)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p5*1.0001] [funit*0.000000:funit*7.000000] \
