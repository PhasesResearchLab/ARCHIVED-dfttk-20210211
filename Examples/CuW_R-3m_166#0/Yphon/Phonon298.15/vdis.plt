...
set xtics ( 'D' qunit*0.000000, '{/Symbol G}' qunit*0.111799, 'Z' qunit*0.167698, 'A' qunit*0.279497, '{/Symbol G}' qunit*0.386537)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*0.000000:funit*8.000000] \
