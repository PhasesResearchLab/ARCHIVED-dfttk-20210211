...
set xtics ( '{/Symbol G}' qunit*0.000000, 'X' qunit*0.112504, 'Y' qunit*0.253276, '{/Symbol G}' qunit*0.337889, 'Z' qunit*0.394593)

set key left top
set ylabel "Frequency (THz)"

plot [x=0:qunit*p4*1.0001] [funit*-1.000000:funit*8.000000] \
